...
public class FraiburgoDecoder implements Decoder.Text<Objeto>{

    private ServiceLogObservacao logObs;
    
    public FraiburgoDecoder(){
    ...
    public void init(EndpointConfig config) {
        System.out.println("Inicio Decoder Fraiburgo "+new Date());
    }

    @Override
    public void destroy() {
        System.out.println("Saída Decoder Fraiburgo "+new Date());
    }
